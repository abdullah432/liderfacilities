...
// //       child: Column(
// //         children: <Widget>[
//         Positioned(top: 0, right: 0, left: 0, bottom: 0, child: SizedBox(child:  Column(children: <Widget>[
//           uperPart(),
//           searchTF(),
//           requestEmpty == true
//               ? Center(
...
//       widget =
//           Text(lang.translate('New'), style: TextStyle(color: Colors.green));
//     else if (record.state == 'Accepted')
//       widget = Text(lang.translate('Accepted'),
//           style: TextStyle(color: Colors.green));
//     else
//       widget =
//           Text(lang.translate('Rejected'), style: TextStyle(color: Colors.red));
